// Site Header - Updated May 28, 2024
function noop() { }
const identity = x => x;
...
function create_each_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*site_nav*/ 4 && t_value !== (t_value = /*link*/ ctx[9].label + "")) set_data(t, t_value);

			if (dirty & /*site_nav*/ 4 && a_href_value !== (a_href_value = /*link*/ ctx[9].url)) {
